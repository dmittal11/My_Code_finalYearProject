    ...
    $('#js-file-validation-example').parsley();
     ...
     window.Parsley
        .addValidator('multipleOf', function (value, requirement) {
            ...
            $.ajax({
            url: 'DashboardController/ajax_check_email',
            data: {
                email: value
            },
            async: false,
        ...
        .addMessage('de', 'multipleOf', 'Diese E-Mail-Adresse existiert bereits.');


        window.Parsley
        .addValidator('multipleOf1', function (value, requirement) {

             var response = false;

               // Your code to perform the ajax, like before
            $.ajax({
            url: 'front/ajax_check_email',
            data: {
                email: value
            },
            async: false,
        ...
        .addMessage('de', 'multipleOf1', 'Diese E-Mail-Adresse existiert bereits.');
