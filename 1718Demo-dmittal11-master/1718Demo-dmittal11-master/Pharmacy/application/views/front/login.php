        ...
        <?php endif; ?>
          ...
          <div class="login_section">
           <div class="logo"><a href="<?=base_url()?>"><h1>Pharmacy</h1></a></div>      
              ...
              <div class="login_field">
               ...
               <form id="sign_in" method="POST" data-parsley-validate>
                  <div class="form-group">
                    ...
                    <input class="form-control" id="exampleInputEmail1" type="email" value="<?=$email?>" name="email" data-parsley-length="[6, 50]" maxlength="50" required placeholder="Email"/>
                  </div>
                  <div class="form-group">
                    <div class="form_icon"><img src="<?= base_url('assets/images/lock.png') ?>" alt=""/></div>
                    <input class="form-control" id="exampleInputPassword1" value="<?=$password?>" name="password" type="password" data-parsley-length="[4, 30]" maxlength="30" required placeholder="Password"/>
                  </div>
            ...
            <div class="clearfix reg-links-row">              
                <a href="forgot" class="forget_password"> Lost your password?</a>           
            </div>
        </div>
      </div>
    </div>
